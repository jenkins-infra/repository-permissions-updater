...
**IMPORTANT:**
When using JEP-229 CD, https://www.jenkins.io/doc/developer/publishing/source-code-hosting/[every committer to your repository] can create new releases by merging pull requests.
